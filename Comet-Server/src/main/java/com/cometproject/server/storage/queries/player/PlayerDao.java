...
public class PlayerDao {
    ...
    public static void updateDisableWhisper(final boolean disableWhisper, int playerId) {
        ...
        try {
            ...
            preparedStatement = sqlConnection.prepareStatement("UPDATE player_settings SET disable_whisper = ? WHERE player_id = ?");
